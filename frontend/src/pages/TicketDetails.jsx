          ...
          <div className="bg-slate-900 p-10 text-white relative">
            ...
            <div className="flex justify-between items-start relative z-10">
              ...
              <div className="text-right">
                ...
                <span className="px-4 py-2 bg-green-500/20 text-green-400 rounded-full font-bold text-xs uppercase tracking-widest border border-green-500/30">Confirmed & Paid</span>
              </div>
            </div>
          </div>
          ...
          <div className="p-10 space-y-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  <div className="w-14 h-14 bg-slate-100 rounded-2xl flex items-center justify-center"><User className="text-slate-400 w-7 h-7" /></div>
                  <div>
                ...
                <div className="flex items-center space-x-4">
                  <div className="w-14 h-14 bg-slate-100 rounded-2xl flex items-center justify-center"><MapPin className="text-slate-400 w-7 h-7" /></div>
                  <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  <div className="w-14 h-14 bg-primary-50 rounded-2xl flex items-center justify-center"><Stethoscope className="text-primary-600 w-7 h-7" /></div>
                  <div>
                ...
                <div className="flex items-center space-x-4">
                  <div className="w-14 h-14 bg-primary-50 rounded-2xl flex items-center justify-center"><Calendar className="text-primary-600 w-7 h-7" /></div>
                  <div>
            ...
            {ticket.jitsiLink && (
              <div className="bg-primary-50 rounded-3xl p-8 border border-primary-100 flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex items-center space-x-4">
                  <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center shadow-sm"><Video className="text-primary-600 w-8 h-8" /></div>
                  <div>
                ...
                <Link to={`/telemedicine?appointmentId=${ticket.appointmentId}`} className="btn btn-primary !px-8 shadow-xl shadow-primary-600/20 whitespace-nowrap">Join Meeting Now</Link>
              </div>
            )}
            ...
            <div className="pt-10 border-t border-dashed border-slate-200 flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="flex items-center space-x-4 text-slate-400">
                ...
                <p className="text-xs font-medium max-w-xs leading-relaxed">This e-ticket is digitally signed and serves as your proof of payment and booking. Please keep it ready during your consultation.</p>
              </div>
              <div className="text-right">
